...
export AZURE_RESOURCE_GROUP=substrate-benchmark-rg
export AZURE_LOCATION=southeastasia

export AKS_CLUSTER_NAME=substrate-benchmark-aks
export AKS_KUBERNETES_VERSION=1.34.8
export AKS_NODE_POOL_NAME=systempool
export AKS_NODE_COUNT=2
export AKS_NODE_VM_SIZE=Standard_D4ds_v6
...
export AZURE_STORAGE_ACCOUNT_NAME=substratebmstorage
...
export AZURE_CONTAINER_REGISTRY_NAME=substratebenchmarkacr
...
export AZURE_ATELET_CLIENT_ID=37258359-0e43-4d6f-bb7f-6342afe4b83b
